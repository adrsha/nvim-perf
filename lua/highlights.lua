...
local ColorSets = {
    ...
    TreeSitterContext = { fg = colors.overlay0, bg = colors.darker },
    TreeSitterContextBottom = { fg = colors.overlay0, bg = colors.darker },
    TreeSitterContextLineNumber = { fg = colors.bg, bg = colors.darker },
